...
export class EmployeeService {
    ...
    private resourceUrl =  SERVER_API_URL + 'organization/api/employees';
    ...
    private convertItemFromServer(employee: Employee): Employee {
        ...
        copy.birthDate = this.dateUtils
            .convertLocalDateFromServer(employee.birthDate);
        copy.workingSince = this.dateUtils
            .convertLocalDateFromServer(employee.workingSince);
        return copy;
    }
    ...
    private convert(employee: Employee): Employee {
        ...
        copy.workingSince = this.dateUtils
            .convertLocalDateToServer(employee.workingSince);
        return copy;
    }
}
